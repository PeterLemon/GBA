; Game Boy Advance 'Bare Metal' BIOS Functions Arithmetic SQRT demo by krom (Peter Lemon):
...
start:
  ...
  PrintString SqrtTEXT, 4224, 23, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  imm32 r9,$0000FF6E ; Load Test Check
...
SqrtTEXT:      db "SQRT $08 (Square Root):"        ; Include BG Map Text Data (23 Bytes)
