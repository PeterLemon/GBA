...
start:
  ...
  PrintString BIT2BPPTEXT, 4224, 22, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  PrintString DEST2BPPTEXT, 4570, 4, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  PrintString DEST4BPPTEXT, 4698, 4, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  PrintString DEST8BPPTEXT, 4826, 4, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  PrintString DEST16BPPTEXT, 4954, 5, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  PrintString DEST32BPPTEXT, 5082, 5, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
...
BITPointer:
  dh 2048 ; Source Data Byte Length
  db 2    ; Source Unit Bit Width (1,2,4,8)
BITDestWidth:
