; Game Boy Advance 'Bare Metal' BIOS Functions Decompress BIT UnPack 8BPP demo by krom (Peter Lemon):
...
start:
  ...
  PrintString BIT8BPPTEXT, 4224, 22, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  PrintString DEST8BPPTEXT, 4570, 4, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  PrintString DEST16BPPTEXT, 4698, 5, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  PrintString DEST32BPPTEXT, 4826, 5, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
...
BITPointer:
  dh 8192 ; Source Data Byte Length
  db 8    ; Source Unit Bit Width (1,2,4,8)
BITDestWidth:
  db 8    ; Destination Unit Bit Width (1,2,4,8,16,32)
...
BIT8BPPTEXT:   db "BIT $10 (UnPack 8BPP):"         ; Include BG Map Text Data (22 Bytes)
