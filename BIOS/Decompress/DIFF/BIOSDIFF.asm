; Game Boy Advance 'Bare Metal' BIOS Functions Decompress DIFF demo by krom (Peter Lemon):
...
start:
  ...
  PrintString DIFF8WRAMTEXT, 4224, 29, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number

  imm32 r0,DATA8 ; Source
  ...
  PrintString DATATEXT, 4432, 4, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  PrintString DIFF8VRAMTEXT, 4608, 30, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  PrintString TestTEXT, 4722, 4, 3 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  PrintString LineBreakTEXT, 4786, 4, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  PrintString DIFF16TEXT, 4992, 24, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number

  imm32 r0,DATA16 ; Source
  mov r1,WRAM     ; Destination
  ...
  PrintString InputTEXT, 5124, 5, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  PrintString TestTEXT, 5106, 4, 3 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  PrintString LineBreakTEXT, 5170, 4, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
...
DATA8:  file 'DATA.d8'  ; Include DIFF  8-Bit Data (4096 Bytes)
DATA16: file 'DATA.d16' ; Include DIFF 16-bit Data (4096 Bytes)
...
DIFF8WRAMTEXT: db "DIFF8 $16 Write 8-BIT (WRAM):"  ; Include BG Map Text Data (29 Bytes)
DIFF8VRAMTEXT: db "DIFF8 $17 Write 16-BIT (VRAM):" ; Include BG Map Text Data (30 Bytes)
DIFF16TEXT:    db "DIFF16 $18 Write 16-BIT:"       ; Include BG Map Text Data (24 Bytes)
