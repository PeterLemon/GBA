; Game Boy Advance 'Bare Metal' BIOS Functions Decompress Huffman demo by krom (Peter Lemon):
...
start:
  ...
  PrintString HUFFMAN4TEXT, 4224, 28, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number

  imm32 r0,DATASIZE4 ; Source
  ...
  PrintString HUFFMAN8TEXT, 4672, 28, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number

  imm32 r0,DATASIZE8 ; Source
...
HUFFMAN4TEXT:  db "HUFFMAN $13 Data Size 4-BIT:"   ; Include BG Map Text Data (28 Bytes)
HUFFMAN8TEXT:  db "HUFFMAN $13 Data Size 8-BIT:"   ; Include BG Map Text Data (28 Bytes)
