; Game Boy Advance 'Bare Metal' BIOS Functions Decompress RLE demo by krom (Peter Lemon):
...
start:
  ...
  PrintString RLEWRAMTEXT, 4224, 27, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number

  imm32 r0,DATARLE ; Source
  ...
  PrintString RLEVRAMTEXT, 4672, 28, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
...
DATARLE: file 'DATA.rle' ; Include RLE Data (2206 Bytes)
align 4
...
RLEWRAMTEXT:   db "RLE $14 Write 8-BIT (WRAM):"    ; Include BG Map Text Data (27 Bytes)
RLEVRAMTEXT:   db "RLE $15 Write 16-BIT (VRAM):"   ; Include BG Map Text Data (28 Bytes)
