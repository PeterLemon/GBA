; Game Boy Advance 'Bare Metal' BIOS Functions Memory Copy CPUSET demo by krom (Peter Lemon):
...
start:
  ...
  PrintString DEST16BITTEXT, 4506, 5, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  PrintString DEST16BITTEXT, 4698, 5, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  imm32 r0,COPYDATA  ; Source Address
  mov r1,WRAM        ; Destination Address
  imm32 r2,$04000400 ; Length/Mode

  PrintString InputTEXT, 4804, 5, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  PrintString R2TEXT, 4816, 4, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  imm32 r9,VALUE
  str r2,[r9]
  ...
  PrintString DATATEXT, 4880, 4, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  PrintString DEST32BITTEXT, 4890, 5, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  PrintString COPYTEXT, 4902, 4, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  imm32 r0,COPYDATA  ; Source Address
  mov r1,WRAM        ; Destination Address
  imm32 r2,$05000400 ; Length/Mode

  PrintString InputTEXT, 4996, 5, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  PrintString R2TEXT, 5008, 4, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  imm32 r9,VALUE
  str r2,[r9]
  PrintValue VALUE, 5018, 4, 2 ; Print Value: Source Address, VRAM Destination, Value Length, Palette Number
  ...
  PrintString DEST32BITTEXT, 5082, 5, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  PrintString FIXEDTEXT, 5094, 5, 0 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  PrintString LineBreakTEXT, 5184, 30, 1 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
...
DEST16BITTEXT: db "16BIT"    ; Include BG Map Text Data (5 Bytes)
