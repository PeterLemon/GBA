; Game Boy Advance 'Bare Metal' BIOS Functions Misc Checksum demo by krom (Peter Lemon):
...
start:
  ...
  PrintString TitleTEXT, 4096, 23, 4 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  PrintString LineBreakTEXT, 4160, 30, 1 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  PrintString ChecksumTEXT, 4224, 29, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
  ...
  imm32 r9,$BAAE187F ; Load Test Check
...
TitleTEXT:     db "GBA BIOS Misc Functions"        ; Include BG Map Text Data (23 Bytes)
LineBreakTEXT: db "------------------------------" ; Include BG Map Text Data (30 Bytes)
ChecksumTEXT:  db "CHECKSUM $0D (BIOS Checksum):"  ; Include BG Map Text Data (29 Bytes)
