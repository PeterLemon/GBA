...
start:
  ...
  PrintString BGAffineSetTEXT, 4224, 16, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number

  imm32 r0,BGAffineSource      ; Source Address
  imm32 r1,BGAffineDestination ; Destination Address
  ...
  imm32 r0,BGAffineDestination ; Data Address
  imm32 r1,BGAffineCheck       ; Check Address
  mov r2,4                     ; Count = Data Length / 4
  TestLOOPA:
...
align 4
BGAffineDestination: ; Memory Area Used To Store BG Affine Transformations Using BIOS Call
  ...
  dw 0 ; Start X Coordinate
  dw 0 ; Start Y Coordinate

BGAffineCheck: ; Memory Area Used To Store BG Affine Transformations Using BIOS Call
  ...
  dw $0001B5C8 ; Start X Coordinate
  dw $000184B8 ; Start Y Coordinate
