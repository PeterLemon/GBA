; Game Boy Advance 'Bare Metal' BIOS Functions Sound Bias demo by krom (Peter Lemon):
...
start:
  ...
  PrintString SoundBiasTEXT, 4224, 14, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number

  mov r0,$200 ; Bias Level
...
SoundBiasTEXT: db "SoundBias $19:"                 ; Include BG Map Text Data (14 Bytes)
