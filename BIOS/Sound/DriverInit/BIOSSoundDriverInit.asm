; Game Boy Advance 'Bare Metal' BIOS Functions Sound DriverInit demo by krom (Peter Lemon):
...
start:
  ...
  PrintString SoundDriverInitTEXT, 4224, 20, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number

  imm32 r0,SoundArea ; Sound Area
...
SoundDriverInitTEXT: db "SoundDriverInit $1A:"           ; Include BG Map Text Data (20 Bytes)
