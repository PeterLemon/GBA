; Game Boy Advance 'Bare Metal' BIOS Functions Sound DriverMain demo by krom (Peter Lemon):
...
start:
  ...
  PrintString SoundDriverMainTEXT, 4224, 20, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
...
SoundDriverMainTEXT: db "SoundDriverMain $1C:"           ; Include BG Map Text Data (20 Bytes)
