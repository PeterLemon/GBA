; Game Boy Advance 'Bare Metal' BIOS Functions Sound DriverVSync demo by krom (Peter Lemon):
...
start:
  ...
  PrintString SoundDriverVSyncTEXT, 4224, 21, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number
