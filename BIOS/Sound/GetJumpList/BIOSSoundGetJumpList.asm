; Game Boy Advance 'Bare Metal' BIOS Functions Sound GetJumpList demo by krom (Peter Lemon):
...
start:
  ...
  PrintString SoundGetJumpListTEXT, 4224, 21, 5 ; Print String: Source Address, VRAM Destination, String Length, Palette Number

  imm32 r0,Destination ; Destination Address
  ...
  imm32 r0,Destination ; Data Address
  imm32 r1,CHECKDATA   ; Check Address
  mov r2,72            ; Count = Data Length / 4
  TestLOOPA:
...
Destination: ; Pointers To 36 Additional Sound-Related BIOS Functions ($120 Bytes Buffer)
  times $120 db 0

CHECKDATA: file 'CHECKDATA.bin' ; Include Check Data ($120 Bytes)
...
SoundGetJumpListTEXT: db "SoundGetJumpList $2A:"          ; Include BG Map Text Data (21 Bytes)
