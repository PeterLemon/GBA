...
; Instruction Cycles
ldr r5,[r10,OldQCycles - MEM_MAP] ; IF (QCycles < OldQCycles) OldQCycles = 0
cmp r12,r5
movlt r5,0
sub r5,r12,r5 ; R5 = InstQCycles = QCycles - OldQCycles (Get Last Instruction Quad Cycle Count)
str r12,[r10,OldQCycles - MEM_MAP] ; OldQCycles = QCycles
...
ldrb r6,[r10,LCDQCycles - MEM_MAP] ; LCDQCycles += InstQCycles
add r6,r5 ; R6 = LCDQCycles
strb r6,[r10,LCDQCycles - MEM_MAP]
imm16 r8,LY_REG
...
; Timers
TIMERS:
ldrh r6,[r10,DIVQCycles - MEM_MAP] ; DIVQCycles += InstQCycles
add r6,r5
...
strb r8,[r10,r7]
NO_DIV:
str r6,[r10,DIVQCycles - MEM_MAP]

imm16 r6,TAC_REG ; IF (TAC_REG & 4) {
ldrb r6,[r10,r6]
tst r6,4
beq NO_TMR
ldr r7,[r10,OldTAC_REG - MEM_MAP] ; IF (TAC_REG != OldTAC_REG) {
cmp r6,r7
beq NO_TAC
str r6,[r10,OldTAC_REG - MEM_MAP] ; OldTAC_REG = TAC_REG
mov r7,4
str r7,[r10,TimerQCycles - MEM_MAP] ; TimerQCycles = 0 }
NO_TAC:

TMR_4096:
  cmp r6,4 ; IF (TAC_REG == 4) { (Timer Clock Frequency = 4096 Hz)
  bne TMR_262144
  ldr r6,[r10,TimerQCycles - MEM_MAP] ; TimerQCycles += InstQCycles
  add r6,r5
  imm16 r5,TIMA_REG
...
strb r5,[r10,r7]
str r6,[r10,TimerQCycles - MEM_MAP] ; Store Timer Cycles
NO_TMR:

; Interrupts
ldrb r5,[r10,IME_FLAG - MEM_MAP]
...
; Joypad
mov r5,P1_REG ; Reset Joypad (P1_REG = $F)
mov r6,$F
strb r6,[r10,r5]