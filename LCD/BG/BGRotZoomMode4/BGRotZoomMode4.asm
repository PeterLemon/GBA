; Game Boy Advance 'Bare Metal' BG Mode 4 Rotate & Zoom Demo by krom (Peter Lemon):
...
BGIMG: file 'BG.img' ; Include BG Image Data (38400 Bytes)
BGPAL: file 'BG.pal' ; Include BG Palette Data (32 Bytes)