; Game Boy Advance 'Bare Metal' BG Mode 5 Rotate & Zoom Demo by krom (Peter Lemon):
...
macro Control { ; Macro To Handle Control Input
  ...
  mov r3,$00005000 ; R3 = Default Screen Center X
  str r3,[r0,0] ; Store Screen Center X To Parameter Table
  mov r3,$00004000 ; R3 = Default Screen Center Y
...
start:
  ...
  DMA32 BGIMG, VRAM, 10240 ; DMA BG Image To VRAM
...
BGIMG: file 'BG.img' ; Include BG Image Data (40960 Bytes)