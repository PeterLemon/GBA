; Game Boy Advance 'Bare Metal' OBJ/Sprite 4BPP Rotate & Zoom Demo by krom (Peter Lemon):
...
start:
  ...
  ; Sprite 16x32
  imm32 r2,(TALL+COLOR_16+0+OBJ_MOSAIC+SIZE_DOUBLE+ROTATION_FLAG)+((SIZE_32+16) * 65536) ; R2 = Attributes 0 & 1
  ...
  ; Sprite 32x16
  imm32 r2,(WIDE+COLOR_16+16+OBJ_MOSAIC+SIZE_DOUBLE+ROTATION_FLAG)+((SIZE_32+88) * 65536) ; R2 = Attributes 0 & 1
  str r2,[r1],4 ; Store Attributes 0 & 1 To OAM, Increment OAM Address To Attribute 2
  mov r2,$08	; R2 = Attribute 2 (Tile Number 8)
  str r2,[r1],4 ; Store Attribute 2 To OAM

  ; Sprite 32x32
  imm32 r2,(SQUARE+COLOR_16+0+OBJ_MOSAIC+SIZE_DOUBLE+ROTATION_FLAG)+((SIZE_32+176) * 65536) ; R2 = Attributes 0 & 1
  str r2,[r1],4 ; Store Attributes 0 & 1 To OAM, Increment OAM Address To Attribute 2
  mov r2,$10	; R2 = Attribute 2 (Tile Number 16)
  str r2,[r1],4 ; Store Attribute 2 To OAM

  ; Sprite 32x64
  imm32 r2,(TALL+COLOR_16+32+OBJ_MOSAIC+SIZE_DOUBLE+ROTATION_FLAG)+((SIZE_64+0) * 65536) ; R2 = Attributes 0 & 1
  str r2,[r1],4 ; Store Attributes 0 & 1 To OAM, Increment OAM Address To Attribute 2
  mov r2,$20	; R2 = Attribute 2 (Tile Number 32)
  str r2,[r1],4 ; Store Attribute 2 To OAM

  ; Sprite 64x32
  imm32 r2,(WIDE+COLOR_16+64+OBJ_MOSAIC+SIZE_DOUBLE+ROTATION_FLAG)+((SIZE_64+56) * 65536) ; R2 = Attributes 0 & 1
  str r2,[r1],4 ; Store Attributes 0 & 1 To OAM, Increment OAM Address To Attribute 2
  mov r2,$40	; R2 = Attribute 2 (Tile Number 64)
  str r2,[r1],4 ; Store Attribute 2 To OAM

  ; Sprite 64x64
  imm32 r2,(SQUARE+COLOR_16+32+OBJ_MOSAIC+SIZE_DOUBLE+ROTATION_FLAG)+((SIZE_64+144) * 65536) ; R2 = Attributes 0 & 1
  str r2,[r1],4 ; Store Attributes 0 & 1 To OAM, Increment OAM Address To Attribute 2
  mov r2,$60	; R2 = Attribute 2 (Tile Number 96)
  ...
  DMA32 SpriteIMG, CHARMEM, 1280 ; DMA OBJ Image Data To VRAM
...
SpriteIMG: ; Include Sprite Bitmap Data (5120 Bytes)
  file 'Sprite16x32.img' ; Include Sprite Bitmap Data (256 Bytes)
  file 'Sprite32x16.img' ; Include Sprite Bitmap Data (256 Bytes)
  file 'Sprite32x32.img' ; Include Sprite Bitmap Data (512 Bytes)
  file 'Sprite32x64.img' ; Include Sprite Bitmap Data (1024 Bytes)
  file 'Sprite64x32.img' ; Include Sprite Bitmap Data (1024 Bytes)
  file 'Sprite64x64.img' ; Include Sprite Bitmap Data (2048 Bytes)
