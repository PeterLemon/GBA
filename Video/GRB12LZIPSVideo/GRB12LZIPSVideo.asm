; GBA 'Bare Metal' GRB 12-Bit LZ Compressed IPS Video Decode Demo by krom (Peter Lemon):
...
macro IPSDecode { ; Decode IPS Headerless & Footerless Data With 2 Byte (Word) Offsets, Little Endian Offset, Size, & RLE Size
  ...
  imm32 r0,WRAM + 25200 ; R0 = IPS Location
...
LoopFrames:
  ...
  imm32 r1,WRAM + 25200 ; R1 = LZ IPS File Output Offset
